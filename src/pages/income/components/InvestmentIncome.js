...
const InvestmentIncome = ({setCategory, cpp_selector, pensionStartAges_reducer, user_reducer, setPensionAge_action, setNestedUserDetail_action}) => {    
    ...
    return (
        <Wrapper>
            <Header>
            <h2>TFSA Contribution & Withdrawal Plan</h2> 
            </Header>
            <Container >                                                                      
...
export default connect(mapStateToProps, {setPensionAge_action, setNestedUserDetail_action})(InvestmentIncome )
