...
const ShortTermAssets = ({netWorth_reducer, addItem_action}) => {    
    ...
    return (
        <Container> 
            <Left>
                <ChooseOne
                        array={["checking Account", "savings account", "garaunteed investment certificates"]}
                        setValue={() => "hi"}
                        value ={1}
                    />
            </Left>
...
export default connect(mapStateToProps, {addItem_action})(ShortTermAssets )
