import React, { Component } from 'page/income/Charts/node_modules/react'
import * as d3 from "page/income/Charts/node_modules/d3"
import style from "./ChartStyles.css"
import _ from "page/income/Charts/node_modules/lodash"
import styled from "page/income/Charts/node_modules/styled-components"
import {stackedChartData, stackedChartKeys} from "page/income/Charts/node_modules/redux/income/income_selectors"
import {connect} from "page/income/Charts/node_modules/react-redux"
...
.attr("class", "axis")
        ...
        //     const height = legendRectSize + legendSpacing + 7;   
        //     const offset =  height * colorScale.domain().length / 1.3;  
        ...
        //         .style("font-size", 10)
        //         .text(d => (
        //             d === "cppIncome" ? "CPP Income" 
        //             :
        //             d === "oasIncome" ? "OAS Income" 
        //             :
        //             d === "tfsa" ? "Reccomended TFSA Income" 
        //             :
        //             d === "rrsp" ? "Reccomended RRSP Income" 
        //             : 
        //             d === "nonRegistered" ? "Reccomended Non-Registered Income" 
        //             : 
        //             d === "employmentIncome" ? "Employment Income" 
        //             : 
        //             d === "businessIncome" ? "Business Income" 
        //             : 
        //             d)); // return name
    }
