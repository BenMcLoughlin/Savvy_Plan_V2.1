...
const drawChart = (props, width, height) => {
    ...
    const color = ["age","#49697B", "#55869D", "#F6BC23", "#F6BC23", "#F29278", "#F29278", "#7DA8B8", '#81CCAF', '#D8BABB', '#B0CFE3','#D4D4D4','#72929B', "#F29278", "#4BB9D0", '#FEDE76', "#7DA8B8", "#81CCAF", '#F7CDAB', '#D8BABB'];
    ...
    const update = data => {
        ...
        const yScale = d3.scaleLinear().range([graphHeight, 0]).domain([1000, d3Max])
