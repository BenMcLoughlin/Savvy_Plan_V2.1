...
//RENDER SAVINGS - SETS ALL VALUES IN SAVINGS ARRAY
 export const renderSavings = (fromAge, toAge, name, value, rangeBarValue, transaction, savingsPerYear_reducer2, transaction_action, rate1, rate2 ) => {
...
export   const optimizedWithdrawals = (account, savingsPerYear_reducer2, setOpitmizedValues_action, rate2) => {
    const futureValue = savingsPerYear_reducer2[65][account].totalValue
...
export   const optimizedContribution = (account, savingsPerYear_reducer2, setOpitmizedValues_action, rate1) => {
    const withdrawalPayment = savingsPerYear_reducer2[72].rrsp.withdraw
